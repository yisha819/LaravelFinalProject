            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-100 p-6">
                ...
                <div class="border-b border-gray-200 pb-5 mb-5">
                    ...
                    <p class="mt-1 max-w-2xl text-sm text-gray-500">
                        Personal details and role application.
                    </p>
                </div>
                ...
                <div class="mt-8 pt-6 border-t border-gray-200 flex space-x-3">
                    <a href="/employees/{{ $employee->id }}/edit" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-500 focus:bg-indigo-500 active:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
